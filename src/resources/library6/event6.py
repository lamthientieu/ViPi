...
class Event(object):
    ...
    def New(event_type, args, **kwargs):
        ...
        """
        event_type = EventType6(event_type)
...
_EVENT_BY_TYPE = {
    EventType6.ON_ALERT_STARTED: AlertEvent,
    EventType6.ON_ALERT_FINISHED: AlertEvent,
    EventType6.ON_DEVICE_ACTION: DeviceActionEvent,
    EventType6.ON_RENDER_RESPONSE: RenderResponseEvent,
    EventType6.ON_MEDIA_TRACK_LOAD: MediaStateChangeEvent,
    EventType6.ON_MEDIA_TRACK_PLAY: MediaStateChangeEvent,
    EventType6.ON_MEDIA_TRACK_STOP: MediaStateChangeEvent,
}
