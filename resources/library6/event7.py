...
class Event(object):
    ...
    def __init__(self, event_type, args, **_):
        if event_type == (2 or 3 or 4 or 5 or 6 or 7 or 8 or 9 or 15):
            event_type = 9
    ...
    def New(event_type, args, **kwargs):
        ...
        """
        event_type = EventType7(event_type)
...
_EVENT_BY_TYPE = {
    EventType7.ON_ALERT_STARTED: AlertEvent,
    EventType7.ON_ALERT_FINISHED: AlertEvent,
    EventType7.ON_DEVICE_ACTION: DeviceActionEvent,
    EventType7.ON_RENDER_RESPONSE: RenderResponseEvent,
    EventType7.ON_MEDIA_TRACK_LOAD: MediaStateChangeEvent,
    EventType7.ON_MEDIA_TRACK_PLAY: MediaStateChangeEvent,
    EventType7.ON_MEDIA_TRACK_STOP: MediaStateChangeEvent,
}
